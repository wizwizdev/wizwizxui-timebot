...
#### اگر از اوبونتو 18 استفاده می کنید، حتما پایتون نسخه 3 را انتخاب کنید، به طور پیش فرض پایتون 2 نصب و انتخاب شده است و هنگام اجرای اسکریپت با خطا مواجه می شوید. اما در اوبونتو 20 و بالاتر به خوبی اجرا می شود
...
#### نام کاربری و پسورد پنل x-ui شما حتما باید ساده باشد ( ترکیبی از عدد حروف ) چون با نام کاربری و پسورد پیچیده مشکل دارد و ربات اجرا نمی شود برای مثال:
