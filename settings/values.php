...
",
    ...
    'start_message'=>'به ربات orv خوش اومدی 
...
مدت زمان سرویس: DAYS روز',
    ...
    'config_not_found'=>"مشکلی پیش اومده، دوباره از اول انجام بده",
    'incorrect_config_name'=>"اسم وارد شده معتبر نمی باشد",
    'pay_with_tron_wallet'=>"  مبلغ AMOUNT ترون رو به والت زیر ارسال کنید و تکسید آیدی واریزی ترون را ارسال کنید :
