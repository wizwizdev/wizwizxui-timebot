...
- اگر از قابلیت reality استفاده میکنید باید سرور رو ثبت کنید بعد به قسمت تنظیمات سرور برید و سروری که قراره این قابلیت رو داشته باشه براش تیک گزینه reality رو فعال کنید ، بعد یه پلن ایجاد کنین و بعد برید مدیریت پلن ها روی اون پلن بزنید و پلن رو انتخاب کنین یه قسمتی هست به اسم dest و یه قسمتی هم به اسم servername این دوتا باید اینجا تنظیم باشن وگرنه موقع دریافت کانفیگ ناقص تحویل میگیرین ...
