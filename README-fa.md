...
### کار نکردن قابلیت بک اپ پنل x-ui




- حتما باید سروری که ربات ویزویز و سروری که پنل xui نصب کردین ابونتو 20 باشه ، اگه یکی 20 و یکی 22 باشه کار نمیکنه



- اگر این امکان برا شما کار نکرد احتمال چندتا مشکل هست! وارد مسیر زیر بشید
...
- اینجا دوتا پوشه وجود داره که wizwizxui-timebot برای ربات هست کاری بهش نداریم ولی یه پوشه دیگه به این اسم و یک عدد رندم وجود داره
...
- این عدد رندم برای هر نفر خاص تولید شده ، اسم این پوشه رو یه جا یادداشت کنین و سپس دستور زیر رو تو سرور بزنید
...
- سپس عدد 1 رو بزنید و بعد میتونید لیست کرون جاب های خودتون رو ببینید، یک فایل به اسم backupnutif.php وجود داره باید اسم پوشه پنل ویزویزی که تو این ادرس قرار گرفته با چیزی که بالا گفتم یادداشت کنید یکی باشه عددش و بعد چک کردن اگر یکی نبود جایگزین کنین و ذخیره کنید



- بعدش تو تنظیمات پنل ویزویز یه بخشی هست به اسم ایدی عددی بک اپ ، یه کانال میزنید و ایدی عددی رو بهش میدید و بعد از بخش بک اپ اطلاعات سرور رو هم بهش میدین و تمام
