...
```
bash <(curl -s https://raw.githubusercontent.com/Aliirad/Arpelnet_sellbot/main/wizwiz.sh)
```
...
```
bash <(curl -s https://raw.githubusercontent.com/Aliirad/Arpelnet_sellbot/main/update.sh)
```
