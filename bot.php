...
if (preg_match('/^\/([Ss]tart)/', $text) or $text == '⤵️ برگرد به منوی اصلی ' or $text == '🔙بازگشت به منوی اصلی' or $data == 'mainMenu') {
    ...
    if(isset($data) and $data == "mainMenu"){
        $res = editText($message_id, 'سلااام به ربات وی پی ان مسترز خوش اومدی 🫡🌸

        وی پی ان تخصص ماست ✅
ما اینجاییم تا شما را بدون هیچ محدویتی به شبکه جهانی متصل کنیم ❤️

☎️ پشتیبانی تا روز آخر 
✅ متصل با تمامیdddddddd اپراتور ها
📡 برقرای امنیت در ارتباط شما
✅ کیفیت در ساخت انواع کانکشن ها
🔄 قابلیت عودت وجه در صورت نارضایتی تا 24 ساعت

🚪 /start
', $mainKeys);
        if(!$res->ok){
            sendMessage('سلااام به ربات وی پی ان مسترز خوش اومدی 🫡🌸

        وی پی ان تخصص ماست ✅
ما اینجاییم تا شما را بدون هیچ محدویتی به شبکه جهانی متصل کنیم ❤️

☎️ پشتیبانی تا روز آخر 
✅ متصل با تمامی ddddddddاپراتور ها
📡 برقرای امنیت در ارتباط شما
✅ کیفیت در ساخت انواع کانکشن ها
🔄 قابلیت عودت وجه در صورت نارضایتی تا 24 ساعت
...
☎️ پشتیبانی تا روز آخر 
✅ متصل با تمامی ddddddddddddاپراتور ها
📡 برقرای امنیت در ارتباط شما
✅ کیفیت در ساخت انواع کانکشن ها
🔄 قابلیت عودت وجه در صورت نارضایتی تا 24 ساعت
